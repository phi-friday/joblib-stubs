...
class Batch[T]:
    def __init__(self, tasks: list[DaskTaskItem[..., T]]) -> None: ...
    def __call__(self, tasks: list[DaskTaskItem[..., T]] | None = ...) -> list[T]: ...
...
class DaskDistributedBackend(
    ...
    def apply_async[T](
        self, func: Callable[[], T], callback: Callable[[T], Any] | None = ...
    ) -> futures.Future[T]: ...
    # mypy
